...
public class ListTeacher extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			List<Teacher> tcr = (List<Teacher>)query.getResultList();

			out.print("<h1 style='align-center' color='green'> Teachers List :- </h1>");
			...
			out.print("</tr>");
			System.out.println(hql);
			Iterator<Teacher> ir = tcr.iterator();
			while(ir.hasNext()) {
				Teacher th = ir.next();
				out.print("<tr>");
				out.print("<td>" + th.getT_name() + "</td>");
				out.print("</tr>");
			}
